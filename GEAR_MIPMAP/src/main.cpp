...
int main(int argc, const char** argv)
{
	...
	shaderCI.recompileArguments.entryPoint = nullptr;
	shaderCI.recompileArguments.shaderModel = nullptr;
	shaderCI.recompileArguments.macros = {};
	shaderCI.recompileArguments.cso = true;
	shaderCI.recompileArguments.spv = true;
	shaderCI.recompileArguments.dxcLocation = nullptr;
	shaderCI.recompileArguments.glslangLocation = nullptr;
	shaderCI.recompileArguments.additioalArguments = nullptr;
