...
namespace gear
{
	...
	namespace scene
	{
		...
		struct GEAR_SCENE_API UUIDComponent
		{
			core::UUID uuid;
		...
		struct GEAR_SCENE_API NameComponent
		{
			std::string name;
		...
		struct GEAR_SCENE_API TransformComponent
		{
		...
		struct GEAR_SCENE_API CameraComponent
		{
		...
		struct GEAR_SCENE_API LightComponent
		{
		...
		struct GEAR_SCENE_API ModelComponent
		{
		...
		struct GEAR_SCENE_API SkyboxComponent
		{
		...
		struct GEAR_SCENE_API TextComponent
		{
