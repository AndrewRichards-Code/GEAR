...
//GEAR API
#ifdef GEAR_ANIMATION_BUILD_DLL
#define GEAR_ANIMATION_API ARC_EXPORT
#else
#define GEAR_ANIMATION_API ARC_IMPORT
#endif

#ifdef GEAR_ASSET_BUILD_DLL
#define GEAR_ASSET_API ARC_EXPORT
#else
#define GEAR_ASSET_API ARC_IMPORT
#endif

#ifdef GEAR_ASSET_MANAGER_BUILD_DLL
#define GEAR_ASSET_MANAGER_API ARC_EXPORT
#else
#define GEAR_ASSET_MANAGER_API ARC_IMPORT
#endif

#ifdef GEAR_AUDIO_BUILD_DLL
#define GEAR_AUDIO_API ARC_EXPORT
#else
#define GEAR_AUDIO_API ARC_IMPORT
#endif

#ifdef GEAR_CORE_BUILD_DLL
#define GEAR_CORE_API ARC_EXPORT
#else
#define GEAR_CORE_API ARC_IMPORT
#endif

#ifdef GEAR_GRAPHICS_BUILD_DLL
#define GEAR_GRAPHICS_API ARC_EXPORT
#else
#define GEAR_GRAPHICS_API ARC_IMPORT
#endif

#ifdef GEAR_IMGUI_BUILD_DLL
#define GEAR_IMGUI_API ARC_EXPORT
#else
#define GEAR_IMGUI_API ARC_IMPORT
#endif

#ifdef GEAR_INPUT_BUILD_DLL
#define GEAR_INPUT_API ARC_EXPORT
#else
#define GEAR_INPUT_API ARC_IMPORT
#endif

#ifdef GEAR_OBJECTS_BUILD_DLL
#define GEAR_OBJECTS_API ARC_EXPORT
#else
#define GEAR_OBJECTS_API ARC_IMPORT
#endif

#ifdef GEAR_PROJECT_BUILD_DLL
#define GEAR_PROJECT_API ARC_EXPORT
#else
#define GEAR_PROJECT_API ARC_IMPORT
#endif

#ifdef GEAR_RENDERING_BUILD_DLL
#define GEAR_RENDERING_API ARC_EXPORT
#else
#define GEAR_RENDERING_API ARC_IMPORT
#endif

#ifdef GEAR_SCENE_BUILD_DLL
#define GEAR_SCENE_API ARC_EXPORT
#else
#define GEAR_SCENE_API ARC_IMPORT
#endif

#ifdef GEAR_SCRIPTING_BUILD_DLL
#define GEAR_SCRIPTING_API ARC_EXPORT
#else
#define GEAR_SCRIPTING_API ARC_IMPORT
#endif

#ifdef GEAR_UI_BUILD_DLL
#define GEAR_UI_API ARC_EXPORT
#else
#define GEAR_UI_API ARC_IMPORT
#endif
