...
namespace gear
{
	namespace objects
	{
		...
		class GEAR_OBJECTS_API Text : public ObjectInterface
		{
		public:
		...
		public:
			...
			~Text();
			void AddLine(const Ref<Font>& font, const std::string& text, const mars::uint2& position, const mars::float4& colour,
