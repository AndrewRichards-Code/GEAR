...
namespace gear
{
	namespace objects
	{
		class GEAR_OBJECTS_API Probe : public ObjectInterface, public ObjectViewInterface
		{
		public:
		...
		private:
			...
			void CalculateViewCameraSubFrusta(std::vector<Frustum>& viewCameraSubFrusta, float& viewCameraNEar, float& viewCameraFar);
		};
	}
}