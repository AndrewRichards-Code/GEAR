...
Ref<AssetManager> Project::s_AssetManager = nullptr;
...
Project::Project(CreateInfo* pCreateInfo)
{
	...
	AssetManager::CreateInfo assetManagerCI;
	assetManagerCI.pAssetRegistryCreateInfo = &assetRegCI;
	assetManagerCI.device = m_CI.device;
	s_AssetManager = CreateRef<EditorAssetManager>(&assetManagerCI);
...
Ref<AssetManager> Project::GetAssetManager()
{
...
{
	return ref_cast<EditorAssetManager>(s_AssetManager);
}
