...
namespace gear
{
	namespace graphics
	{
		...
		class GEAR_GRAPHICS_API Colour_Base
		{
		protected:
		...
		class GEAR_GRAPHICS_API Colour_CIE_XYZ final : public Colour_Base
		{
		public:
			float x;
			float y;
		...
		class GEAR_GRAPHICS_API Colour_sRGB final : public Colour_Base
		{
		public:
		...
		class GEAR_GRAPHICS_API Colour_Rec709 final : public Colour_Base
		{
		public:
		...
		class GEAR_GRAPHICS_API Colour_Rec2020 final : public Colour_Base
		{
		public:
