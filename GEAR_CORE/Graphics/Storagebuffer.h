...
namespace gear
{
	namespace graphics
	{
		class GEAR_GRAPHICS_API BaseStoragebuffer
		{
		public:
		...
		template<typename T>
		class GEAR_GRAPHICS_API Storagebuffer : public BaseStoragebuffer
		{
		public:
			struct CreateInfo
			{
		...
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::Camera>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::Lights>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::SpecularIrradianceInfo>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::BloomInfo>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::ProbeInfo>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::DebugProbeInfo>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::Model>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::HDRInfo>;
		extern template class ARC_IMPORT Storagebuffer<UniformBufferStructures::PBRConstants>;
#endif
	}
}