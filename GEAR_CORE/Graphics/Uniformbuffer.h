...
namespace gear 
{
	namespace graphics
	{
		class GEAR_GRAPHICS_API BaseUniformbuffer
		{
		public:
		...
		template<typename T>
		class GEAR_GRAPHICS_API Uniformbuffer : public T, public BaseUniformbuffer
		{
		public:
			struct CreateInfo
			{
...
#ifndef GEAR_GRAPHICS_BUILD_DLL
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::Camera>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::Lights>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::SpecularIrradianceInfo>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::BloomInfo>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::ProbeInfo>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::DebugProbeInfo>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::Model>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::HDRInfo>;
		extern template class ARC_IMPORT Uniformbuffer<UniformBufferStructures::PBRConstants>;
#endif
	}
}