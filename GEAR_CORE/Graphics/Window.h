...
namespace gear 
{
	namespace graphics
	{
		class GEAR_GRAPHICS_API Window
		{
		public:
			...
			struct CreateInfo
			{
				...
				Ref<asset::ImageAssetDataBuffer>			iconData;
			};
		...
		public:
			...
			static void UpdateWindowCreateInfo(const core::ConfigFile& configFile, graphics::Window::CreateInfo& windowCI);
		};
	}
}