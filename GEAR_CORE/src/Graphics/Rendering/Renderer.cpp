...
void Renderer::InitialiseRenderPipelines(const Ref<RenderSurface>& renderSurface)
{
	...
	{
		{ std::string("res/pipelines/PBROpaque.grpf"),				{ RenderSurface::HDRFormat },	RenderSurface::DepthFormat },
		{ std::string("res/pipelines/Cube.grpf"),					{ RenderSurface::HDRFormat },	RenderSurface::DepthFormat },
		{ std::string("res/pipelines/Text.grpf"),					{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ std::string("res/pipelines/HDR.grpf"),					{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ std::string("res/pipelines/DebugCoordinateAxes.grpf"),	{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ std::string("res/pipelines/DebugCopy.grpf"),				{ swapchainFormat },			Image::Format::UNKNOWN},
		{ std::string("res/pipelines/DebugShowDepth.grpf"),			{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ std::string("res/pipelines/DebugShowDepthCubemap.grpf"),	{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ std::string("res/pipelines/Mipmap.grpf"),					{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/MipmapArray.grpf"),			{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/EquirectangularToCube.grpf"),	{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/DiffuseIrradiance.grpf"),		{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/SpecularIrradiance.grpf"),		{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/SpecularBRDF_LUT.grpf"),		{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/BloomPrefilter.grpf"),			{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/BloomDownsample.grpf"),		{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/BloomUpsample.grpf"),			{},								Image::Format::UNKNOWN },
		{ std::string("res/pipelines/Shadow.grpf"),					{},								RenderSurface::DepthFormat },
	};
