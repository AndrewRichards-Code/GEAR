...
namespace graphics
{
	...
	protected:
		...
		mars::Mat3 RGB_To_XYZ;
		mars::Mat3 XYZ_To_RGB;
	...
	public:
		...
		Colour_CIE_XYZ(const mars::Vec3& colour);

		operator mars::Vec3() const
		{
			return { x, y, z };
		}
	...
	public:
		...
		typedef mars::Vec4 Colour_Linear_sRGB;
	...
	public:
		...
		Colour_sRGB(const mars::Vec4& RGBA);
	...
	public:
		...
		typedef mars::Vec4 Colour_Linear_Rec709;
	...
	public:
		...
		Colour_Rec709(const mars::Vec4& RGBA);
	...
	public:
		...
		typedef mars::Vec4 Colour_Linear_Rec2020;
	...
	public:
		...
		Colour_Rec2020(const mars::Vec4& RGBA);
