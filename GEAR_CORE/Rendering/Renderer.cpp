...
#include "Rendering/Passes/TransferPasses.h"
#include "Rendering/Passes/MipmapPasses.h"
#include "Rendering/Passes/SkyboxPasses.h"
#include "Rendering/Passes/ShadowPasses.h"
#include "Rendering/Passes/MainRenderPasses.h"
#include "Rendering/Passes/PostProcessingPasses.h"
#include "Rendering/Passes/OnScreenDisplayPasses.h"
#include "Rendering/Passes/SwapchinUIPasses.h"
...
void Renderer::InitialiseRenderPipelines(const Ref<RenderSurface>& renderSurface)
{
	...
	{
		{ "Resources/Pipelines/PBROpaque.grpf",				{ RenderSurface::HDRFormat },	RenderSurface::DepthFormat },
		{ "Resources/Pipelines/Cube.grpf",					{ RenderSurface::HDRFormat },	RenderSurface::DepthFormat },
		{ "Resources/Pipelines/Text.grpf",					{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ "Resources/Pipelines/HDR.grpf",					{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ "Resources/Pipelines/DebugBoxes.grpf",			{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ "Resources/Pipelines/DebugCoordinateAxes.grpf",	{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ "Resources/Pipelines/DebugCopy.grpf",				{ swapchainFormat },			Image::Format::UNKNOWN },
		{ "Resources/Pipelines/DebugShowDepth.grpf",		{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ "Resources/Pipelines/DebugShowDepthCubemap.grpf",	{ RenderSurface::SRGBFormat },	Image::Format::UNKNOWN },
		{ "Resources/Pipelines/Mipmap.grpf",				{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/MipmapArray.grpf",			{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/EquirectangularToCube.grpf",	{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/DiffuseIrradiance.grpf",		{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/SpecularIrradiance.grpf",	{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/SpecularBRDF_LUT.grpf",		{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/BloomPrefilter.grpf",		{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/BloomDownsample.grpf",		{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/BloomUpsample.grpf",			{},								Image::Format::UNKNOWN },
		{ "Resources/Pipelines/ShadowCascades.grpf",		{},								RenderSurface::DepthFormat },
		{ "Resources/Pipelines/ShadowSingle.grpf",			{},								RenderSurface::DepthFormat },
	};
...
void Renderer::SubmitUIContext(ui::UIContext* uiContext, PFN_SetPassParameters pfnSetPassParameters, PFN_RenderDrawData pfnRenderDrawData)
{
	m_UIContext = uiContext;
	m_PFN_SetPassParameters = pfnSetPassParameters;
	m_PFN_RenderDrawData = pfnRenderDrawData;
}
...
void Renderer::Draw()
{
	...
	//Frame
	{
		...
		{
			passes::SwapchinUIPasses::ExternalUI(*this, m_UIContext, m_PFN_SetPassParameters, m_PFN_RenderDrawData);
		}
	}
