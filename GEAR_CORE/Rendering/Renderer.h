...
namespace gear
{
	...
	{
		class GEAR_RENDERING_API Renderer
		{
		public:
			struct CreateInfo
			{
			...
			typedef void (gear::ui::UIContext::* PFN_RenderDrawData)(const miru::base::CommandBufferRef& cmdBuffer, uint32_t frameIndex);
			typedef void (gear::ui::UIContext::* PFN_SetPassParameters)(Ref<rendering::TaskPassParameters>& passParameters);
		...
		private:
			...
			PFN_SetPassParameters m_PFN_SetPassParameters = nullptr;
			PFN_RenderDrawData m_PFN_RenderDrawData = nullptr;
		...
		public:
			...
			void SubmitUIContext(ui::UIContext* uiContext, PFN_SetPassParameters pfnSetPassParameters, PFN_RenderDrawData pfnRenderDrawData);
