...
namespace gear
{
	...
	namespace graphics::rendering
	{
		...
		class GEAR_RENDERING_API PassParameters
		{
			//structs/enums
		protected:
		...
		class GEAR_RENDERING_API TaskPassParameters final : public PassParameters
		{
			//Methods
		public:
		...
		class GEAR_RENDERING_API TransferPassParameters final : public PassParameters
		{
			//struct/enum
		public:
