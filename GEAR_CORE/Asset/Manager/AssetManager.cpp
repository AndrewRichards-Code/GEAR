	...
	: m_AssetRegistry(pCreateInfo->pAssetRegistryCreateInfo)
{
	...
	AssetSerialiser::SetAssetManager(Ref<AssetManager>(Ref<AssetManager>(), this)); //Aliasing Constructor: https://en.cppreference.com/w/cpp/memory/shared_ptr/shared_ptr
}
