...
//#include "Asset/Serialiser/AudioSerialiser.h"  //TODO: fix me
#include "Asset/Serialiser/ExternalFileSerialiser.h"
//#include "Asset/Serialiser/FontSerialiser.h" //TODO: fix me
...
std::map<Asset::Type, AssetSerialiser::AssetDeserialiseFunction> AssetSerialiser::s_AssetDeserialiseFunctions = {
	//{ Asset::Type::AUDIO,			AudioSerialiser::Deserialise },  //TODO: fix me
	{ Asset::Type::EXTERNAL_FILE,	ExternalFileSerialiser::Deserialise },
	//{ Asset::Type::FONT,			FontSerialiser::Deserialise },  //TODO: fix me
...
std::map<Asset::Type, AssetSerialiser::AssetSerialiseFunctions> AssetSerialiser::s_AssetSerialiseFunctions = {
	//{ Asset::Type::AUDIO,			AudioSerialiser::Serialise },  //TODO: fix me
	{ Asset::Type::EXTERNAL_FILE,	ExternalFileSerialiser::Serialise },
	//{ Asset::Type::FONT,			FontSerialiser::Serialise },  //TODO: fix me
...
void AssetSerialiser::SetAssetManager(const Ref<manager::AssetManager>& assetManager)
{
	s_AssetManager = assetManager;
}

Ref<manager::AssetManager> AssetSerialiser::GetAssetManager()
{
